 ...
 <div class="py-3 bg-warning">
  ...
  <form action="edituser.php" method="post">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
			<input type="text" name="fname" class="form-control m-2 w-50" placeholder="Name">
			<input type="text" name="lname" class="form-control m-2 w-50" placeholder="Surname">
			<input type="text" name="tel" class="form-control m-2 w-50" placeholder="Tel">
			<input type="date" name="DOB" class="form-control m-2 w-50" placeholder="DOB" >
		  </div>
      </div>
      <div class="row">
        <div class="col-md-12"><input class="btn m-3 btn-primary" type="submit" value="Save Change" ></div>
      </div>
    </div>
  </div>
	</form>
