...
<body>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center text-dark" style="">
          <div class="col-md-12">
            <h1 class="text-left">My Ticket</h1>
          </div>
          <ul class="nav nav-pills">
            <li class="nav-item" style=""> <a href="" class="active nav-link" data-toggle="pill" data-target="#tabone">Your QR code</a> </li>
            <li class="nav-item text-dark"> <a class="nav-link" href="buy_ticket.php"><b></b></a> </li><a class="btn btn-danger" href="refund_history.php" >REFUND</a>
          </ul>
          <div class="tab-content mt-2">
            <div class="tab-pane fade show active" id="tabone" role="tabpanel">
              <p class="">THE 25th DBee Music Festival<br>Please show this QR code to entering the festival.</p><img class="img-fluid d-block mx-auto" src="DBee_QRcode.png">
            </div>
          </div>
        </div>
      </div>
